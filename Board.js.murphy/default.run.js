...
if(Object.keys(Board({id:"5a938de4e0c2896bd94c7434"}).lists({name: "Test from"})).length != 1)
    console.log("Got back incorrect list from Board.lists with string");

if(Object.keys(Board({id:"5a938de4e0c2896bd94c7434"}).lists({name: new RegExp("Test .+")})).length != 2)
