...
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("My Test Field","Ohai!");
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("My Test Dropdown","Yes");
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("Oh yeah",true);
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("My Test Date",Trellinator.now());
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("My Test Number",7);
Card.findOrCreate(new Trellinator().board("Iain Dooley Sandbox").findOrCreateList("Custom Field Test"),"Custom 2").setCustomFieldValue("Non-existent field","yeah baby");
